...
<div class="container">
    ...
    <div>
        ...
        <form id="orderForm" action="/controllers/submit_order.php" method="post">
            ...
            <input type="text" name="orderForm">
            ...
            <label for="address">Nr domu:</label>
            ...
            <label for="invoice">Dane do faktury:</label>
            <textarea id="invoice" name="invoice" rows="4"></textarea><br>
